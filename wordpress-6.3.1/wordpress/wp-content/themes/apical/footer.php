...
<div class="publicite baspage">
  <div class="pubhebergement">
    ...
    <p><a href="https://www.a2hosting.com/?aid=5ca65a17be949&amp;bid=ed1c4a67" target="_top"><img src="http://www.a2hosting.com/?aid=5ca65a17be949" alt="" title="" width="728" height="90"></a>
    <img style="border:0" src="https://affiliates.a2hosting.com/accounts/default1/banners/ed1c4a67.jpg" alt="ed1c4a67" title="" width="728" height="90"><img style="border:0" src="https://affiliates.a2hosting.com/scripts/imp.php?aid=5ca65a17be949&amp;bid=ed1c4a67" width="1" height="1" alt="imp"></p>
  </div>
</div>
<footer>
  <div class="container">
...
<div class="popupchristiane" id="popuprecherche">
  <form method="get" action="https://apical.xyz/rechercherFormationsPagesAjax">
    <input name="rechercher" type="text" id="rechercher" placeholder="Rechercher" required=""> <a id="soumettrerecherche" href="#"><img src="../medias/commun/BoutonRechercher.svg" class="boutonrechercher" title="Rechercher dans tout le site" alt="Soumettre"></a>
  </form>
</div>
